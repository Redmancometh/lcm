...
public class ork {
	...
	public ork(URL url, String auth) throws IOException {
		this(url, url, auth);
	}
	
	public ork(URL url, URL mainUrl, String auth) throws IOException {
		this((HttpURLConnection) url.openConnection(), url, auth);
	}

	public ork(HttpURLConnection conn, URL mainUrl, String auth) throws IOException {
	...
	public boolean meetsTarget(int nonce, asher hasher) throws GeneralSecurityException {
	...
	public static boolean test() {
		try {
			...
			byte[] hash = new asher().hash(header);
